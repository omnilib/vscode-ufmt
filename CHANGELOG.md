...
- Fixed support for projects selecting ruff-api as formatter/sorter (#141)
- Upgrade bundled ruff-api to `v0.2.0`, including ruff `v0.14.3` and 2025 formatting style (#142)

```text
$ git shortlog -s v2025.11.4...v2025.11.5
     2	Amethyst Reese
```
...
```text
$ git shortlog -s v2025.10.28...v2025.11.4
     4	Amethyst Reese
```
